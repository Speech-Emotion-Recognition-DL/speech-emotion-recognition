...
for emotion_num in range(len(emotions_dict_3)):
...
print(
    f'{len(y_train)} training sample labels, {len(y_valid)} validation sample labels, {len(y_test)} test sample labels')
print(
...
model = parallel_all_you_want(len(emotions_dict_3))
...
model = parallel_all_you_want(num_emotions=len(emotions_dict_3)).to(device)
...
def train(optimizer, model, num_epochs, X_train, Y_train, X_valid, Y_valid):
    ...
    for epoch in range(num_epochs):
        ...
        checkpoint_filename = 'C:/Users/97252/Documents/GitHub/speech-emotion-recognition/project/checkpoints/parallel_all_you_wantFINAL-{:03d}.pkl'.format(
            epoch)
    ...
    print("1 ", train_losses)
    print("2 ", valid_losses)
    print("3", train_accuracies)
    print("4", valid_accuracies)
    ...
    plt.title('Accuracies for Parallel is All You Want Model')
...
if __name__ == '__main__':
    ...
    load_folder = 'C:/Users/97252/Documents/GitHub/speech-emotion-recognition/project/checkpoints'
